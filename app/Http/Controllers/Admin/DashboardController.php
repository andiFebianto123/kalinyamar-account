...
class DashboardController extends CrudController
{
    ...
    public function dataNonRutinMonitoring()
    {
        ...
        $monitoring_result = CustomHelper::profitLostRepository()
            ...
            ->select(
                DB::raw("SUM(client_po.job_value) as total_job_value"),
                DB::raw("SUM(client_po.job_value_include_ppn) as price_total_str"),
                DB::raw("SUM((IFNULL(project_profit_lost.price_after_year, 0) + IFNULL(vouchers.biaya, 0) + IFNULL(project_profit_lost.price_small_cash, 0))) as price_total"),
